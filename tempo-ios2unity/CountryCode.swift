...
public class CountryCode {
    ...
    public static func printOtherDetails() {
        ...
        if #available(iOS 16.0, *) {
            if currentLocale.currency != nil {
                currencyCode = currentLocale.currency!.identifier
            } else{
                currencyCode = ""
            }
        } else {
    ...
    public static func getIsoCountryCode3Digit() -> String
    {
        ...
        if(currencyCode == "") {
            print("3 digit country code not recognised, returning: \"\"")
        }
        else {
            print("3 digit country recognised, returning: \(currencyCode)")
        }
        return currencyCode
    }
